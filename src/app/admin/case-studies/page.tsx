    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12 bg-surface rounded-lg border border-border">
          <p className="text-text-muted mb-4">No case studies found</p>
          <Link
            href="/admin/case-studies/new"
              ...
              {caseStudies.map((cs) => (
                <tr key={cs.id} className="hover:bg-surface-hover transition-colors">
                  <td className="px-4 py-3">
                    <div>
                      <p className="text-foreground font-medium">{cs.locales.en.title}</p>
                      <p className="text-text-muted text-sm">/{cs.slug}</p>
                    </div>
                  </td>
                  <td className="px-4 py-3 text-text-muted">{cs.client}</td>
                  <td className="px-4 py-3">
