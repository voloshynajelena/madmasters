...
// Seed data from the existing portfolio
const seedProjects = [
  {
    slug: 'orangeschool',
    name: 'Orange School',
    ...
    images: ['/content/img/portfolio/orangeschool.png', '/content/img/portfolio/orange.png', '/content/img/portfolio/oranges.png'],
  ...
  },
  {
    ...
    images: ['/content/img/portfolio/yudenko.png', '/content/img/portfolio/yudenko-1.png', '/content/img/portfolio/yudenko-2.png', '/content/img/portfolio/yudenko-3.png', '/content/img/portfolio/yudenko-4.png', '/content/img/portfolio/yudenko-5.png', '/content/img/portfolio/yudenko-6.png'],
    client: 'Anna Yudenko',
    industry: 'Design',
    year: 2023,
  ...
  },
  {
    ...
    images: ['/content/img/portfolio/slimbeauty.png', '/content/img/portfolio/massage1.png', '/content/img/portfolio/massage2.png'],
  ...
  },
  {
    ...
    images: ['/content/img/portfolio/dneprlaw.png', '/content/img/portfolio/dneprlaw-1.png', '/content/img/portfolio/dneprlaw2.png'],
  ...
  },
  {
    ...
    images: ['/content/img/portfolio/winplast.png'],
    client: 'Winplast LLC',
  ...
  },
  {
    ...
    images: ['/content/img/portfolio/macarons.png', '/content/img/portfolio/macarone1.png'],
  ...
  },
  {
    ...
    images: ['/content/img/portfolio/avocado.png', '/content/img/portfolio/avokado.png'],
  ...
  },
  {
    ...
    images: ['/content/img/portfolio/teplogarant.png'],
    client: 'Teplogarant',
    industry: 'HVAC',
    year: 2022,
  ...
  },
  {
    ...
    images: ['/content/img/portfolio/photovis.png'],
  ...
  },
  {
    ...
    images: ['/content/img/portfolio/pc-zp1.png', '/content/img/portfolio/pc-zp2.png', '/content/img/portfolio/pc-zp3.png', '/content/img/portfolio/pc-zp4.png'],
    client: 'PC-ZP',
  ...
  },
  {
    ...
    images: ['/content/img/portfolio/stroy-group.png'],
    client: 'Stroy Group',
  ...
  },
  {
    ...
    images: ['/content/img/portfolio/portfolio-atlantika.png'],
  ...
  },
  {
    ...
    images: ['/content/img/portfolio/best-pc.png'],
  ...
  },
  {
    ...
    images: ['/content/img/portfolio/bitovyxa.png'],
    client: 'Bitovyxa',
    industry: 'Retail',
    year: 2022,
  ...
  },
  {
    ...
    images: ['/content/img/portfolio/btech.png'],
  ...
  try {
    ...
    if (!existing.empty) {
      return NextResponse.json(
        { error: 'Portfolio already has data. Delete existing items first to re-seed.' },
        { status: 400 }
      );
    }
    ...
    return NextResponse.json({
      success: true,
      message: `Seeded ${seedProjects.length} portfolio projects`,
    });
  } catch (error) {
    console.error('Error seeding portfolio:', error);
    return NextResponse.json({ error: 'Failed to seed portfolio' }, { status: 500 });
  }
}
