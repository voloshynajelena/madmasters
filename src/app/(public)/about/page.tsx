              ...
              <div>
                ...
                <ul className="space-y-3 sm:space-y-4">
                  <li className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Quality First</h3>
                      <p className="text-gray-600 text-xs sm:text-sm">Every project meets W3C and Google standards</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3 sm:gap-4">
                    <div className="w-8 sm:w-10 h-8 sm:h-10 rounded-full bg-accent/10 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Speed & Performance</h3>
                      <p className="text-gray-600 text-xs sm:text-sm">Optimized for Google PageSpeed and Core Web Vitals</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3 sm:gap-4">
                    <div className="w-8 sm:w-10 h-8 sm:h-10 rounded-full bg-accent/10 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Client-Oriented</h3>
                  ...
                  <li className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Innovation</h3>
                      <p className="text-gray-600 text-xs sm:text-sm">Modern technologies and creative solutions</p>
                    </div>
                  </li>
                </ul>
              </div>
