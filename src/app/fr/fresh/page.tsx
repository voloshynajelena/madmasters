        ...
        <div className="container-section">
          ...
          {loading ? (
            <div className="text-center py-12">
              ...
              <p className="text-foreground/60 mt-4">Chargement...</p>
            </div>
          ) : filteredItems.length === 0 ? (
            <div className="text-center py-12 bg-surface rounded-lg">
              <p className="text-foreground/60">Aucun travail récent trouvé</p>
            </div>
          ) : (
                    ...
                    {item.metrics && Object.keys(item.metrics).length > 0 && (
                      <div className="flex items-center gap-4 mt-4 text-sm text-foreground/50">
                        ...
                        {item.metrics.downloads && (
                          <span className="text-xs">{item.metrics.downloads} téléchargements</span>
                        )}
