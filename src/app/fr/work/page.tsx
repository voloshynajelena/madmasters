        ...
        <div className="container-section">
          ...
          <div className="mt-10 sm:mt-16 grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-6">
            <div className="text-center p-4 sm:p-6 bg-surface rounded-xl">
              ...
              <div className="text-foreground/60 text-xs sm:text-sm">Projets Réalisés</div>
            </div>
            <div className="text-center p-4 sm:p-6 bg-surface rounded-xl">
              <div className="text-2xl sm:text-3xl font-bold text-accent mb-1">50+</div>
              <div className="text-foreground/60 text-xs sm:text-sm">Clients Satisfaits</div>
            </div>
            <div className="text-center p-4 sm:p-6 bg-surface rounded-xl">
              <div className="text-2xl sm:text-3xl font-bold text-accent mb-1">10+</div>
              <div className="text-foreground/60 text-xs sm:text-sm">Années d'Expérience</div>
            </div>
            <div className="text-center p-4 sm:p-6 bg-surface rounded-xl">
              <div className="text-2xl sm:text-3xl font-bold text-accent mb-1">100%</div>
              <div className="text-foreground/60 text-xs sm:text-sm">Satisfaction Client</div>
            </div>
          </div>
        </div>
      </div>
