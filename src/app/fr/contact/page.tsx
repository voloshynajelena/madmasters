...
export default function ContactPage() {
  ...
  const { get } = useContent(undefined, 'fr');
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900">Heures de travail</h3>
                      <p className="text-gray-600">{get('contact.hours_weekday', 'Lun-Jeu: 09:00-19:00')}</p>
                      <p className="text-gray-600">{get('contact.hours_friday', 'Ven: 09:00-18:00')}</p>
                    </div>
                  </div>
