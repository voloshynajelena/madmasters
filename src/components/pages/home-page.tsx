      ...
      <ScrollSection index={4} className="mesh-gradient">
        <div className="flex flex-col items-center justify-center h-full px-4 py-12">
          <div className="container-section text-center">
            <span className="inline-block px-4 py-1 rounded-full bg-accent/10 text-accent text-xs font-medium tracking-wider mb-4">
              OUR WORK
            </span>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 max-w-4xl mx-auto">
              {[
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-end p-4">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-10">
              <Link
                href={`${prefix}/work`}
                className="px-6 py-3 bg-primary text-white text-sm font-medium rounded-lg hover:bg-primary-light transition-colors"
              >
                {dict.cta.seeAll}
              </Link>
              <Link
                href={`${prefix}/fresh`}
                className="px-6 py-3 border-2 border-primary/20 text-primary text-sm font-medium rounded-lg hover:border-primary hover:bg-primary/5 transition-all flex items-center gap-2"
              >
